--- @class CleaveFuryModule : CleaveBase
--- @diagnostic disable: duplicate-set-field
CleaveFuryModule = setmetatable({}, { __index = CleaveBase })
CleaveFuryModule.__index = CleaveFuryModule

--- @return CleaveFuryModule
function CleaveFuryModule.new()
    --- @class CleaveFuryModule
    return setmetatable(CleaveBase.new(), CleaveFuryModule)
end

--- @param context WarriorModuleRunContext
--- @return integer
function CleaveFuryModule:getSpecPriority(context)
