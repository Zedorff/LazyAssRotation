...
function Warrior:EnableFurySpec()
    ModuleRegistry:RegisterGroup(1, "Next swing", function()
...
function Warrior:EnableArmsSpec()
    ...
    ModuleRegistry:RegisterGroup(2, "Primary", function()
