--- @alias HolyFireTrackers { holyFireTracker: HolyFireTracker, purifyingFlamesTracker: PurifyingFlamesTracker }
...
function HolyFireModule:getPriority(context)
    if self.enabled and Helpers:SpellReady(Abilities.HolyFire.name) then
