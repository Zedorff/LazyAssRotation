...
function LightningStrikeModule.new()
    ...
    return setmetatable(Module.new(Abilities.LightningStrike.name, trackers, "Interface\\Icons\\Spell_Nature_ThunderClap"), LightningStrikeModule)
end

function LightningStrikeModule:run()
    Logging:Debug("Casting "..Abilities.LightningStrike.name)
    CastSpellByName(Abilities.LightningStrike.name)
end
